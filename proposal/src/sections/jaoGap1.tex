...
% 	\centering
% 	\vspace{5mm}
% 	\includegraphics[width=0.45\textwidth]{src/Figures/MassLumDisconZ001Paper.pdf}
...
% 	them of 0.001 M$_{\odot}$ (top). Derivative of luminosity with respect to
% 	mass for the OPAL and OPLIB models (bottom).}
% 	\label{fig:coarseMassLum}
% 	\includegraphics[width=0.45\textwidth]{src/Figures/MassLumDisconZ001PaperTeff.pdf}
% 	\caption{Temperature-Luminosity relation for Z=0.01 at 7 Gyr for models run
% 	with both OPAL and OPLIB high-temperature opacity tables and a mass step
% 	between them of 0.001 M$_{\odot}$ (top). Derivative of the luminosity with
% 	respect to the temperature for the OPAL and OPLIB models (bottom)}
% 	\label{fig:coarseTeffLum}
% \end{figure}
