...
\begin{figure*}[ht!]
	\centering
	\includegraphics[width=0.45\textwidth]{figures/jaoOpacity/OPAL_Jao_locator.pdf}
	\includegraphics[width=0.45\textwidth]{figures/jaoOpacity/OPLIB_Jao_locator.pdf}
...
\begin{figure}
	\centering
	\includegraphics[width=0.45\textwidth]{figures/jaoOpacity/SameMassConvectiveZoneComp.pdf}
...
\begin{figure}
	\centering
	\includegraphics[width=0.45\textwidth]{figures/jaoOpacity/Core3HECompSameMass.pdf}
