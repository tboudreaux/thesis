...
\begin{figure*}[ht!]
	\centering
	\includegraphics[width=0.85\textwidth]{figures/jaoOpacity/OPAL_Jao_locator.pdf}
	\includegraphics[width=0.85\textwidth]{figures/jaoOpacity/OPLIB_Jao_locator.pdf}
