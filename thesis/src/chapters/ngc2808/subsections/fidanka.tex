...
\begin{figure}
	\centering
	\includegraphics[width=0.45\textwidth]{figures/ngc2808/notebookFigures/DensityBinsDemo.png}
...
\begin{figure}
	\centering
	\includegraphics[width=0.45\textwidth]{figures/ngc2808/vertFit.png}
...
\begin{figure}
  \centering
  \includegraphics[width=0.45\textwidth]{figures/ngc2808/ExtractedIsoFit.pdf}
...
from 1000 {\bf Monte-Carlo} trials and shows the mean and width of the percent
...
\begin{figure}
  \centering
  \includegraphics[width=0.45\textwidth]{figures/ngc2808/DistributionOfErrors.pdf}
