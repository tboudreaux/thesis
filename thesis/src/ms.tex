...
\prefaceText{\input{misc/prelud.tex}}
\abstractText{\input{misc/abstract.tex}}
...
\input{chapters/jaoOpacity/jaoOpacity.tex}

\chapter{Jao Gap connection to Magnatism}
\input{chapters/jaoMagActivity/jaoMagActivity.tex}

\part{Individual Stars}
\chapter{Magnetic Fields In M Dwarfs}
\input{chapters/magActivity/magActivity.tex}

\input{chapters/rgb_bump/rgbb.tex}
